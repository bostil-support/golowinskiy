window.onload = function () {
    if (sessionStorage.getItem('htmlPage') !== null) {
        ...
        let url = "/Product/ProductDetailById?id=" + id + "&position=" + position + "&isChange=";
...
function categoryClickSuccess(data) {
    ...
    if ($(window).width() <= 900) {
        ...
        $.ajax({
            type: "GET",
            url: "/Category/BreadCrumbs?categoryId=" + chooseCategoryId + "&action=" + false,
            success: function (data) {
...
function goToEditPage(id, position) {
