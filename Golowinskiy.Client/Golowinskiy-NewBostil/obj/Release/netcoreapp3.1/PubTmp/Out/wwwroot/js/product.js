...
function attachMainImage(input) {
    ...
    if (document.getElementById('mainImage').value !== '') {
        ...
        document.getElementById('remove-main').style.display = 'inline';
    }
}
...
function categoryClick(li, categoryId, event) {
    ...
    $.ajax({
        type: "GET",
        url: "/Category/BreadCrumbs?categoryId=" + productCategoryId + "&action=" + true,
...
function goToCategory() {
    ...
    localStorage.setItem('id', productCategoryId);
